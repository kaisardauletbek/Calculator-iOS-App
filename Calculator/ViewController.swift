...
//  Calculator
//
//  Created by Kaisar Dauletbek on 01.03.2021.
//
...
class ViewController: UIViewController {
    ...
    private func setupNumberPad(){
        ...
        resultLabel.frame = CGRect(x:0, y: clearButton.frame.origin.y - 110.0, width: view.frame.size.width, height: 100)
